    ...
    <footer>
      <div className="container">
        <div className="footer-brand">
          ...
          <p>Formación laboral, talleres de oficio y trabajos de herrería profesional. Acompañamos a jóvenes y adultos con oportunidades reales. Santa Fe, Argentina.</p>
        </div>
        <div>
          <h4>Enlaces</h4>
          <ul>
            ...
            <li><Link to="/herreria">Herrería</Link></li>
        ...
        <div className="footer-bottom">
          ...
          <span>&copy; {year} Asociación Civil Monseñor Antonio Rodríguez. Constituida legalmente el 15 de junio de 2010. Todos los derechos reservados.</span>
          <span>CUIT 30-71164449-7 | IGPJ Res. Nº 406</span>
        </div>
      </div>
    </footer>
  )
