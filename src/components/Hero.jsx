      ...
      <div className="container">
        <div className="hero-content">
          <div className="hero-badge">
            ...
            Asociación Civil · Santa Fe · Desde 2008
          </div>
          <h1>
          ...
          <p style={{ fontSize: '1.2rem', fontWeight: 500, marginBottom: '1rem' }}>
            No encontraste trabajo. Querés emprender. Necesitás un oficio para arrancar.
          </p>
          <p>
            En la Asociación Monseñor Antonio Rodríguez acompañamos a jóvenes y adultos
            que buscan una oportunidad real. Talleres de formación laboral, oficios con
            salida laboral y una comunidad que te apoya para que construyas tu futuro.
          </p>
