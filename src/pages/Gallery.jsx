    ...
    <>
      <section className="page-hero">
        <div className="container">
          ...
          <p>Momentos de nuestras actividades, eventos y trabajo comunitario.</p>
        </div>
      </section>
      <Gallery />
      <section className="cta-section">
        <div className="container">
          <h2>¿Tenés fotos para compartir?</h2>
          <p>
            Si participaste de alguna de nuestras actividades y querés compartir tus fotos,
