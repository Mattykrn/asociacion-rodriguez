    ...
    <>
      <section className="page-hero">
        <div className="container">
          ...
          <p>Capacitación y desarrollo para toda la comunidad.</p>
        </div>
      </section>
        ...
        <div className="container">
          <div style={{ textAlign: 'center', marginBottom: '3rem' }}>
            ...
            <p className="section-subtitle" style={{ margin: '0 auto' }}>
              Ofrecemos espacios de formación gratuitos para fortalecer habilidades y conocimientos.
            </p>
          </div>
      ...
      <section className="cta-section">
        <div className="container">
          <h2>¿Consultas sobre los talleres?</h2>
